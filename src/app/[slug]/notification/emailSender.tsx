    ...
    return (
        <div className="flex flex-col gap-5 px-5 w-full">
            <div className="flex flex-col gap-1">
                ...
                <select onChange={(e) => setOption(Number(e.target.value) as options)} name="option" id="" className="bg-transparent p-3 rounded-xl outline outline-1 outline-outline">
            ...
            {option === options.specific &&
                <>
                    <div className="flex flex-col gap-1">
                        ...
                        <select name="student" className="bg-transparent p-3 rounded-xl outline outline-1 outline-outline">
                            <option value="">---</option>
                            {students.filter((s) => s.grade.id === grade).map((s) => (<option key={s.student.id} value={s.student.id}>{s.student.lastName} {s.student.firstName}</option>))}
                        </select>
                    </div>
                    <div className="flex flex-col gap-1">
                        <label htmlFor="">Asunto</label>
