...
export default async function Page() {
    ...
    async function create(data: FormData) {
        ...
        const savedStudent = await db.select().from(student).where(eq(student.email, newStudent.data.email))
                    ...
                    <Modal buttonText="Crear" confirmButton={{ text: "sape", type: "submit" }}>
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="flex-none basis-1/2 grow w-full">
                                ...
                                <select name="studentGrade" className=" outline outline-1 outline-outline rounded p-4 w-full">
                                    <option value="">----</option>
                        ...
                        <div className="grid grid-cols-2 gap-4 border rounded-lg p-2">
                            <TextField label="Nombre y apellido" name="contactName" id=""></TextField>
                            <TextField label="E-mail" name="contactEmail" id=""></TextField>
                            <TextField label="telefono" name="contactPhone" id=""></TextField>
                            <div className="flex flex-col justify-center">
                                <label htmlFor="">Tipo</label>
                                <select name="contactType" id="" className=" outline outline-1 outline-outline rounded p-4 w-full">
                                    <option value="-">---</option>
